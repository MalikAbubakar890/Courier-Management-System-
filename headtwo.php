    ...
    <header class="navbar-area">
        <div class="navbar-top">
            <div class="logo d-none d-lg-block">
                <a class="main-logo" href="index.php">
                    <img src="assetstwo/img/logo.png" style="width: 36%;" alt="img">
                </a>
            </div>
            <div class="nav-phone-wrap">
                <i class="fas fa-phone-alt"></i> +92 3032740775
            </div>
            <div class="container p-lg-0">
                <div class="row">
                    <div class="col-lg-10 col-md-10 text-md-start text-center">
                        <ul class="topbar-left">
                            <li><svg width="12" height="17" viewBox="0 0 12 17" fill="none" xmlns="http://www.w3.org/2000/svg">
                                ...
                                </svg> shop, 5, Negin City Center, Kirani Rd, Hazara Town, Quetta, Balochistan 87300</li>
                            <li><i class="far fa-clock"></i>Mon - Sat: 9 am - 9 pm, Sunday: CLOSED</li>
                        </ul>
                    </div>
                    <div class="col-lg-2 col-md-2">
                        <ul class="topbar-right social-area text-md-end text-center">
                            <li>
                                <a href="https://www.facebook.com/profile.php?id=100085946005765&mibextid=ZbWKwL"><i class="fab fa-facebook-f" aria-hidden="true"></i></a>
                            </li>
                            <li>
                                <a href="https://www.instagram.com/apex_logistics.pk/"><i class="fab fa-instagram" aria-hidden="true"></i></a>
                            </li>
                        </ul>
                    </div>
                </div>
        ...
        <nav class="navbar navbar-area-1 navbar-area navbar-expand-lg">
            <div class="container nav-container">
                ...
                <div class="logo">
                    <a href="index.php"><img src="assetstwo/img/logo-2.png" alt="img"></a>
                </div>
                ...
                <div class="nav-right-part nav-right-part-mobile">
                    ...
                    <a class="btn btn-base" href="getqoute.php"><span>
                      </span> Get A Quote
                    </a>
                </div>
                ...
                <div class="nav-right-part nav-right-part-desktop">
                    ...
                    <a class="btn btn-base" href="track-courier.php"><span>
                      </span> Track Shipment
                    </a>
                    <a class="btn btn-base" href="getqoute.php"><span>
                      </span> Get A Quote
