    ...
    <header class="navbar-area">
        <div class="navbar-top">
            <div class="logo d-none d-lg-block">
                <a class="main-logo" href="home.html"><img src="assetstwo/img/logo-2.png" style="width: 36%;" alt="img"></a>
            </div>
            <div class="nav-phone-wrap">
                <i class="fas fa-phone-alt"></i> +18882079275
            </div>
                    ...
                    <div class="col-lg-10 col-md-9 text-md-start text-center">
                        <ul class="topbar-left">
                            <li><svg width="12" height="17" viewBox="0 0 12 17" fill="none" xmlns="http://www.w3.org/2000/svg">
                                ...
                                </svg> 2500 Southbranch Blvd A, United States</li>
        ...
        <nav class="navbar navbar-area-1 navbar-area navbar-expand-lg">
            <div class="container nav-container">
                ...
                <div class="logo">
                    <a href="home.html"><img src="assetstwo/img/logo-2.png" alt="img"></a>
                </div>
