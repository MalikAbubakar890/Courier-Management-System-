...
(function($) {
    ...
    $(document).ready(function() {
        ...
        /* -----------------------------------------------------
            Variables
        ----------------------------------------------------- */
        var leftArrow = '<img src="assetstwotwo/img/icon/left-arrow.png">';
        var rightArrow = '<img src="assetstwotwo/img/icon/right-arrow.png">';
        ...
        $('.banner-slider').owlCarousel({
            ...
            items: 1,
            smartSpeed: 1800,
            navText: ['<img src="assetstwo/img/icon/left-arrow.png"/>', '<img src="assetstwo/img/icon/right-arrow.png"/>'],
        });
