    ...
    t.scroll(function () {
      ...
      t
        .on("resize", function () {
          var s, o, l;
          (o =
            t.width() < 1200 && a.hasClass("hide-topbar-mobile")
              ? 0
              : e(".topbar").outerHeight(!0)),
            a.hasClass("admin-bar")
              ? (n.css({
                  top: o + 32,
                }),
            ...
            t.on("scroll", function () {
              (o =
                t.width() < 1200 && a.hasClass("hide-topbar-mobile")
                  ...
                  : e(".topbar").outerHeight(!0)),
                (l = o),
                (a.hasClass("header-v4") || a.hasClass("header-v3")) &&
                  (l = o + e(".site-contact").outerHeight(!0)),
                t.scrollTop() > l
                  ? (i.addClass("minimized"),
                    e("#fh-header-minimized").addClass("minimized"))
                  : (i.removeClass("minimized"),
                    e("#fh-header-minimized").removeClass("minimized"));
            }),
            (s =
              a.hasClass("header-v3") && t.width() > 1199
                ? e(".site-menu").outerHeight(!0)
                : i.outerHeight(!0)),
            a.hasClass("header-sticky") && e("#fh-header-minimized").height(s);
        })
        .trigger("resize"),
      ...
      e("ul.filter").on("click", "li", function (a) {
        ...
        t.hasClass("active") ||
          (t.closest(".filters-dropdown").next(".list-project").isotope({
            filter: i,
          }),
    ...
    /*for (var l = e(".page-header .header-title"), r = 0; r < l.length; r++) e(l[r]).parallax("50%", .6);
      ...
      a.on("click", ".navbar-toggle", function (t) {
        t.preventDefault(),
          ...
          a.toggleClass("display-mobile-menu");
      }),
      e("ul.menu li.menu-item-has-children a").addClass("dropdown-toggle"),
      a.on("click", "#toggle-search", function (a) {
        a.preventDefault(),
          e(this).parents(".topbar-search").toggleClass("display-search");
      }),
      a.on("click", ".menu-item-search .toggle-search", function (a) {
        a.preventDefault(),
          e(this).parents(".menu-item-search").toggleClass("display-search");
      }),
      s
      ...
      s.find(".menu .menu-item-has-children").each(function () {
        var a = "";
        e(this).children("a").hasClass("dropdown-toggle") &&
          (a = e(this).children(".dropdown-toggle").html()),
          e(this)
            .children("ul")
            .prepend('<li class="menu-parent-items">' + a + "</li>"),
          e(this)
            .children("ul")
            .prepend(
              '<li class="menu-back">' + cargohub.cargohub_back + "</li>"
            );
      }),
      s
        .find(".menu .menu-item-has-children")
        .on("click", ".toggle-children", function (a) {
          a.preventDefault(),
      ...
      s
        .find(".menu .menu-item-has-children")
        .on("click", ".menu-back", function (a) {
          a.preventDefault(),
            e(this).closest("ul").closest("li").removeClass("over-menu"),
            s.find(".menu .menu-item-has-children").hasClass("over-menu") ||
              s.find(".menu").removeClass("over-submenu");
        }),
      ...
      (function () {
        ...
        t.addClass("active"),
          s.filter(":first").addClass("active"),
          i.html(t.html()),
          ...
          a.on("click", function () {
            ...
            t.hasClass("active") ||
              (i.html(t.html()),
              i.parent().toggleClass("show-office"),
