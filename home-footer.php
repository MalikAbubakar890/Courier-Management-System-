 <!-- footer area start -->
    <footer class="footer-area">
        <div class="footer-top" style="background-image: url(assetstwo/img/footer/bg.png);">
            <div class="container">
                <div class="row justify-content-center">
                    <div class="col-lg-4 col-md-6">
                        <div class="single-footer-top">
                            <div class="icon">
                                <img src="assetstwo/img/icon/map-marker.png" alt="img">
                            </div>
                            <div class="details">
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="single-footer-top">
                            <div class="icon">
                                <img src="assetstwo/img/icon/phone.png" alt="img">
                            </div>
                            <div class="details">
                                <h6>CONTACT US:</h6>
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="single-footer-top after-none">
                            <div class="icon">
                                <img src="assetstwo/img/icon/clock.png" alt="img">
                            </div>
                            <div class="details">
                                <h6>WORKING HOURS:</h6>
            ...
            <div class="row">
                <div class="col-xl-4 col-md-6">
                    <div class="widget widget_about">
                        <div class="thumb">
                            <img src="assetstwo/img/logo-white.png" alt="img">
                        </div>
                        <div class="details">
    ...
    <!-- all plugins here -->
    <script src="assetstwo/js/vendor.js"></script>
    <!-- main js  -->
    <script src="assetstwo/js/main.js"></script>