      ...
      <div class="c">
		...
		<div class="card-body">
			<form action="" id="manage_user">
				...
				<div class="row">
					<div class="col-md-6 border-right">
						...
						<div class="form-group">
							...
							<input type="text" name="contact" class="form-control " required value="<?php echo isset($contact) ? $contact : '' ?>">
						</div>
						<div class="form-group">
				...
				<hr>
				<div class="col-lg-12 text-right justify-content-end d-flex">
